var resultWrapper = $(".spin-result-wrapper, .pop-up-window"), wheel = $(".wheel-img");
$(".spin_active").on("click", (function (e) {
  $(this).off(e), wheel.hasClass("rotated") ? resultWrapper.css({display: "block"}) : (wheel.addClass("super-rotation"), setTimeout((function () {
    ...
    $("#clock").countdown(e, {elapse: !0}).on("update.countdown", (function (e) {
      var o = $(this);
      e.elapsed ? o.html("00:00") : o.html(e.strftime("<span>%M</span> : <span>%S</span>"))
    }))
  }), 9500), wheel.addClass("rotated"))
})), $(document).keydown((function (e) {
  27 === e.keyCode && resultWrapper.fadeOut()
})), $(".close-popup, .spin-result-wrapper").click((function () {
  resultWrapper.fadeOut()
})), $("a").on("touchend, click", (function (e) {
  e.preventDefault(), $("body,html").animate({scrollTop: $(".scroll_to_form").offset().top}, 400)
})), $(".ac_footer a, .ac_gdpr_fix a").unbind("click"), $("header, footer ul").hover((function () {
