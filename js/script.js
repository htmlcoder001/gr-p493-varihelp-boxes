$(document).ready((function () {
  $(".boxes > div").click((function () {
    $(this).parent().hasClass("boxesfirsttry") ? ($(".boxes").removeClass("boxesfirsttry"), $(this).addClass("openbox"), $(this).find(".try").hide(), $(this).find(".opentry").show(), setTimeout((function () {
      ...
      $(".new-comebacker-overlay").is(":visible") && $(".new-comebacker-overlay").hide(), $(".new-comebacker-overlay .boxes-is-open").show(), $(".new-comebacker-overlay .boxes-not-open").hide(), $(".spin-result-wrapper").show(), setTimeout((function () {
        $("#boxesContainer").slideUp(250), setTimeout((function () {
          $(".order_block").slideDown(250)
        }), 500), start_timer(), $("body,html").animate({scrollTop: $(".scroll_to_form").offset().top}, 400)
      }), 500)
    }), 500)))
